...
showcase_tag="template" ## create a tag to be used in the shiny app

### First row (Title + Research question) ####
    ## add text to research question
    showcase[[showcase_tag]]$question$text = "Add research question here" ## adds title to showcase
    ...
    showcase[[showcase_tag]]$title$text="Add showcase title here"
    
    ## add subtext to title
    showcase[[showcase_tag]]$title$subtext1 = "Add title subtext here"
...
### Second row (Workflow) ####
    ...
    ### Third row (Results) ####
    showcase[[showcase_tag]]$results$title= "Add results title here"
...
### Forth row (Discussion) ####
    showcase[[showcase_tag]]$discussion$title= "Add discussion title here"
...
### Fith row (Methods) ####
    showcase[[showcase_tag]]$methods$title= "Add methods title here"
